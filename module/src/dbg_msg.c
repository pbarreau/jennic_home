...
PUBLIC char const *dbg_etFlashMsg[] = { "E_FLASH_BP_TEST_SORTIES",
    "E_FLASH_OFF", "E_FLASH_RECHERCHE_RESEAU", "E_FLASH_RECHERCHE_BC",
...
PUBLIC char const *dbg_etDefWifiMsg[] = { "E_MSG_NOT_SET", "E_MSG_DATA_ALL",
    ...
    "E_MSG_NET_LED_ON", "E_MSG_ASK_RESET_CARD", "E_MSG_ASK_ERASE_FLASH",
